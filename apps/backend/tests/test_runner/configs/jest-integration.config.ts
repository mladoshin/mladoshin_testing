...
const config: Config = {
  ...
  // Test pattern - only .spec.ts files in integration test folders
  // This matches integration tests in src/modules/**/tests/integration/*.spec.ts
  testRegex: 'src/modules/.*/tests/integration/.*\\.spec\\.ts$',
